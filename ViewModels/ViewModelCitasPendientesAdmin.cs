...
{
    public class ViewModelCitasPendientesAdmin
    {
        ...
        public ViewModelCitasPendientesAdmin(string child, bool cargar)
        {
            childString = child;
            _firebase = new FirebaseClient(new Controllers.Config().GetUrlCitasPendientesAdmin());
            if (cargar){
                ListenToChanges();
            }
        }
